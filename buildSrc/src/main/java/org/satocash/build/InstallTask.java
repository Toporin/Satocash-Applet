...
public class InstallTask extends DefaultTask {
  ...
  // Satocash constants
  //5361746f63617368
  public static final byte[] PACKAGE_AID = Hex.decode("5361746f63617368");
  public static final byte[] SATOCASH_AID = Hex.decode("5361746f6361736800");
  public static final byte[] SATOCASH_INSTANCE_AID = Hex.decode("5361746f6361736800");
  public static final byte[] NDEF_AID = Hex.decode("5361746f6361736801");
  ...
  public void install() {
    ...
    try {
      ...
      InputStream in = new FileInputStream(this.getProject().file("build/javacard/org/satocash/applet/javacard/applet.cap"));
      ...
      logger.info("Installing the Satocash Applet");
      cmdSet.installForInstall(PACKAGE_AID, SATOCASH_AID, SATOCASH_INSTANCE_AID, new byte[0]).checkOK();
